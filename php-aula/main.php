...
<body>
    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            role="button" aria-haspopup="true" aria-expanded="false">Produtos
            ...
            <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
            role="button" aria-haspopup="true" aria-expanded="false"> Fornecedores
            <span class="caret"></span></a>
            <ul class="dropdown-menu">
            ...
            <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
             role="button" aria-haspopup="true" aria-expanded="false"> Categorias
             <span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="?page=5">Cadastrar</a></li>
